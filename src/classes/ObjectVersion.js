...
ObjectVersion.register = (workspaceName, item) => DBAccess.register(workspaceName, item)
ObjectVersion.registerMany = (workspaceName, items) => DBAccess.registerMany(workspaceName, items)
